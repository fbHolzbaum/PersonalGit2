<html>
	...
	<body id="body" class="greybody">
		...
		<div id="mobilenavigationOff">
			...
			<div id="navigation2">
				<a href="games.php" onclick="CallNavigation()">GAMES</a><p onclick="CallSubNavigation(2)" id="arrow2">&#x25BC;</p>
		...
		<p id="linebreak">&nbsp;</p>
		<div id="gamechoice">
			<div id="gamechoiceimage">
				<img src="images/squared/squared_titleimage.jpg">
			</div>
			<div id="gamechoiceinfo">
				
					<a href="squared.php" class="buttonlink">Learn More</a>
			</div>
		</div>
